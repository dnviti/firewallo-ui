...
class TestRunner:
    """Test runner for WebUI plugin tests."""
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        print("🧪 Running WebUI Plugin Test Suite")
        print("=" * 60)
    ...
    def _print_summary(self, overall_success: bool, total_time: float):
        ...
        if overall_success:
            print("\n🎉 All tests passed! WebUI plugin is ready for production.")
        else:
